        ...
        <View style={styles.container}>
            <View style={styles.inputContainer}>
                <TextInput
                    ...
                    value={input}
                />
                <Button title="Generate Hash" onPress={generateHash}/>
            </View>
            <View style={styles.pickerContainer}>
                ...
                <View style={styles.picker}>
                    <Button
                        ...
                        color={algorithm === '256' ? '#2196f3' : '#888'}
                    />
                    <Button
                        title="SHA-384"
                        onPress={() => setAlgorithm('384')}
                        color={algorithm === '384' ? '#2196f3' : '#888'}
                    />
                    <Button
                        title="SHA-512"
                        onPress={() => setAlgorithm('512')}
                        color={algorithm === '512' ? '#2196f3' : '#888'}
                    />
                </View>
            </View>
            <Text style={styles.text}>Hash: {hash}</Text>
            <Button title="Generate Random Bytes" onPress={generateRandomBytes}/>
